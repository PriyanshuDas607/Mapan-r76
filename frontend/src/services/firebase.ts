...
export const firebaseConfig = {
  ...
  databaseURL: import.meta.env.VITE_FIREBASE_DATABASE_URL || "https://mapan-1013c-default-rtdb.firebaseio.com",
  ...
  measurementId: import.meta.env.VITE_FIREBASE_MEASUREMENT_ID || "G-2V9Z9E8N00",
}
